...
urlpatterns = [
    ...
    path('user/detail', views.get_user_detail, name='userDetail'),
    ...
    path('adv/search-old', views.search_old, name='searchOld'),
    path('adv/search', views.search, name='search'),

    path('get-cities', views.get_cities, name='getCities'),
